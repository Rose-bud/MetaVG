...
def all_gather(data):
    """
    Run all_gather on arbitrary picklable data_beifen (not necessarily tensors)
    Args:
        data: any picklable object
    Returns:
        list[data_beifen]: list of data_beifen gathered from each rank
    """
